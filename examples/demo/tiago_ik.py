import sys
import yaml
from gibson2.core.physics.robot_locomotors import Turtlebot, JR2_Kinova, Fetch, Tiago_Single
...
def main():
    ...
    #                                           'arm_left_6_joint',
    #                                           'arm_left_7_joint'])
    arm_joints = joints_from_names(robot_id, ['arm_1_joint',
                                               'arm_2_joint',
                                               'arm_3_joint',
                                               'arm_4_joint',
                                               'arm_5_joint',
    ...
    end_index = start_index + robot.arm_dim
